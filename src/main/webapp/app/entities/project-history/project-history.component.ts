...
export default class ProjectHistory extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllProjectHistorys();
  }
  ...
  public retrieveAllProjectHistorys(): void {
  ...
  public prepareRemove(instance: IProjectHistory): void {
  ...
  public removeProjectHistory(): void {
    this.projectHistoryService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('testApp.projectHistory.deleted', { param: this.removeId });
