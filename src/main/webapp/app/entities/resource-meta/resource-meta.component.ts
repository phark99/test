...
export default class ResourceMeta extends Vue {
  ...
  public retrieveAllResourceMetas(): void {
  ...
  public prepareRemove(instance: IResourceMeta): void {
  ...
  public removeResourceMeta(): void {
    this.resourceMetaService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('testApp.resourceMeta.deleted', { param: this.removeId });
