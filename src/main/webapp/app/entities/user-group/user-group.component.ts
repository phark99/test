...
export default class UserGroup extends Vue {
  ...
  public retrieveAllUserGroups(): void {
  ...
  public prepareRemove(instance: IUserGroup): void {
  ...
  public removeUserGroup(): void {
    this.userGroupService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('testApp.userGroup.deleted', { param: this.removeId });
